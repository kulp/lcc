...
reg:  CALLI1(acon)          "[O] <- P + 2; P <- %0\n"
reg:  CALLU1(acon)          "[O] <- P + 2; P <- %0\n"
reg:  CALLP1(acon)          "[O] <- P + 2; P <- %0\n"
stmt: CALLV(acon)           "[O] <- P + 2; P <- %0\n"

reg:  CALLI1(reg)           "[O] <- P + 2; P <- %0\n"
reg:  CALLU1(reg)           "[O] <- P + 2; P <- %0\n"
